<template>
  <TresMesh
    ref="boxRef"
    @click="onBoxClick"
    @questioner-enter="onquestionerenter"
    @questioner-leave="onquestionerleave"
  >
...
function onquestionerenter() {
  document.body.style.cursor = "questioner";
}

function onquestionerleave() {
