...
import DeveloperSKillModal from "@/components/modal/DeveloperSKillModal";
import SkillComponet from "@/components/SkillComponet";
let typedText = ref("");
let txt = `안녕하세요. 하루하루 성장해나가며 기쁨을 느끼는 \n 웹 개발자 김동원 입니다.`;
let i = 0;
const ViewText = () => {
  if (i < txt.length) {
